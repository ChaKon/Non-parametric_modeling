function [cfr] = rls_primalrecinitrandfeats(X, y, opt)
...
% Random features sampling
% Warning, this sampling is just for the gaussian kernel
[cfr.proj.W, cfr.proj.b] = rp_projections_custom( size(X,2), opt.randfeats.D , 'gaussian');

X = rp_apply_real_custom(X',cfr.proj)';
